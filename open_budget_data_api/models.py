...
class Budget(db.Model):
    ...
    equiv_code = db.Column(ARRAY(db.String))
    group_full = db.Column(ARRAY(db.String))
    group_top = db.Column(ARRAY(db.String))
    class_full = db.Column(ARRAY(db.String))
    class_top = db.Column(ARRAY(db.String))
    kind = db.Column(ARRAY(db.String))
    subkind = db.Column(ARRAY(db.String))
